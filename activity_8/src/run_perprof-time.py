...
print(data)
perfprof(data, linespecs=['red', 'blue', 'green', 'black', 'purple', 'yellow'], legendnames=namesMH,  title = "Best solution in 1 minute", nameFile = outBaseDir + "/oneminute", fontsize = 20, tickfontsize = 20, legendfontsize = 14, titlefontsize = 20, legendpos = 'center left')
